...
PROGRAM: .DB 0x20, 0x20, 0x4C, 0x41, 0x37, 0x34, 0x20, 0x20, 0x20, 0x0
...
SEARCH_LIST_SYMBOL_CALLBACK:
    ...
    adiw R31:R30, 1
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_171
    andi R31, 127
    lpm R16, Z+
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_172
LOAD_SRAM_GCPTR_171:
    ld R16, Z+
DONE_LOAD_GCPTR_172:
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_173
    andi R31, 127
    lpm R17, Z+
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_174
LOAD_SRAM_GCPTR_173:
    ld R17, Z+
DONE_LOAD_GCPTR_174:
    ...
    call SYMBOL_COMPARE
    tst RET_NONPTR_LO
    breq SUCCESS_CONDITION_END_176
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_177
    andi R31, 127
    lpm RET_PTR_LO, Z+
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_178
LOAD_SRAM_GCPTR_177:
    ld RET_PTR_LO, Z+
DONE_LOAD_GCPTR_178:
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_179
    andi R31, 127
    lpm RET_PTR_HI, Z
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_180
LOAD_SRAM_GCPTR_179:
    ld RET_PTR_HI, Z
DONE_LOAD_GCPTR_180:
...
BEGIN_LOOP_186:
    call ASM_READ_CHAR
    tst RET_NONPTR_HI
    breq SUCCESS_CONDITION_END_188
 ; argument to is-char-numeric
    mov R16, RET_NONPTR_LO
    call IS_CHAR_NUMERIC
    tst RET_NONPTR_HI
    breq FAILURE_CONDITION_START_189
    ...
    rjmp FAILURE_CONDITION_END_190
FAILURE_CONDITION_START_189:
    ;; The character in r16 is non-numeric; unput it
    call ASM_UNPUT_CHAR
    jmp END_LOOP_187
FAILURE_CONDITION_END_190:
    jmp BEGIN_LOOP_186
SUCCESS_CONDITION_END_188:
END_LOOP_187:
...
ASM_READ_CHAR:
 ...
 ;;; Reads a character and returns it in RET-NONPTR-LO; RET-NONPTR-HI is 0 if EOF, nonzero otherwise
    ...
    ;; to indicate success
    tst R16
    breq SUCCESS_CONDITION_END_198
...
SYMBOL_COMPARE:
 ...
 ; Skip the header byte
    adiw R31:R30, 1
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_199
    andi R31, 127
    lpm R20, Z+
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_200
LOAD_SRAM_GCPTR_199:
    ld R20, Z+
DONE_LOAD_GCPTR_200:
    ...
    adiw R31:R30, 1
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_201
    andi R31, 127
    lpm R21, Z+
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_202
LOAD_SRAM_GCPTR_201:
    ld R21, Z+
DONE_LOAD_GCPTR_202:
 ...
 ; Ensure the lengths are equal, and if so, compare each byte in the representation for equality
    cp R20, R21
    brne SUCCESS_CONDITION_END_203
BEGIN_LOOP_204:
    tst R20
    breq SUCCESS_CONDITION_END_206
    movw R31:R30, R17:R16
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_207
    andi R31, 127
    lpm R21, Z+
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_208
LOAD_SRAM_GCPTR_207:
    ld R21, Z+
DONE_LOAD_GCPTR_208:
    movw R17:R16, R31:R30
    movw R31:R30, R19:R18
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_209
    andi R31, 127
    lpm R22, Z+
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_210
LOAD_SRAM_GCPTR_209:
    ld R22, Z+
DONE_LOAD_GCPTR_210:
    movw R19:R18, R31:R30
    cp R21, R22
    breq SUCCESS_CONDITION_END_211
    jmp END_LOOP_205
SUCCESS_CONDITION_END_211:
    dec R20
    jmp BEGIN_LOOP_204
SUCCESS_CONDITION_END_206:
END_LOOP_205:
SUCCESS_CONDITION_END_203:
    tst R20
    brne SUCCESS_CONDITION_END_212
    inc RET_NONPTR_LO
SUCCESS_CONDITION_END_212:
    pop R20
    pop R21
    pop R22
    pop R31
...
CHECK_OBJ_TYPES_EQUAL:
 ...
 ;;; If the arguments have the same type and that type is r20, RET-NONPTR-LO will be nonzero; otherwise, it will be zero.
    ...
    movw R31:R30, R17:R16
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_213
    andi R31, 127
    lpm R16, Z
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_214
LOAD_SRAM_GCPTR_213:
    ld R16, Z
DONE_LOAD_GCPTR_214:
    movw R31:R30, R19:R18
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_215
    andi R31, 127
    lpm R17, Z
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_216
LOAD_SRAM_GCPTR_215:
    ld R17, Z
DONE_LOAD_GCPTR_216:
 ...
 ; Mask off the program/sram tag
    ...
    cp R16, R17
    brne SUCCESS_CONDITION_END_217
    cp R16, R20
    brne SUCCESS_CONDITION_END_218
    inc RET_NONPTR_LO
SUCCESS_CONDITION_END_218:
SUCCESS_CONDITION_END_217:
    pop R31
    pop R30
    pop R16
    pop R17
...
TRY_READ_AGAIN_219:
    ...
    tst RET_NONPTR_HI
    breq FAILURE_CONDITION_START_220
    mov R16, RET_NONPTR_LO
    ...
    tst RET_NONPTR_HI
    breq FAILURE_CONDITION_START_222
...
CALL_DONE_225:
    tst RET_NONPTR_LO
    brne SUCCESS_CONDITION_END_226
    jmp TRY_READ_AGAIN_219
SUCCESS_CONDITION_END_226:
    rjmp FAILURE_CONDITION_END_223
FAILURE_CONDITION_START_222:
    clr RET_NONPTR_LO
FAILURE_CONDITION_END_223:
    rjmp FAILURE_CONDITION_END_221
FAILURE_CONDITION_START_220:
    clr RET_NONPTR_LO
FAILURE_CONDITION_END_221:
    pop R16
    pop R17
    pop R18
    pop R19
...
ARRAY_INDEX:
 ...
 ;;; Indexes the given lisp array (of pointers) at the given position
    ...
    movw R31:R30, R17:R16
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_227
    andi R31, 127
    lpm R16, Z+
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_228
LOAD_SRAM_GCPTR_227:
    ld R16, Z+
DONE_LOAD_GCPTR_228:
    cpi R16, READTABLE_OBJECT_ID
    breq SUCCESS_CONDITION_END_229
    call FATAL_ERROR
SUCCESS_CONDITION_END_229:
    ...
    adc R31, R19
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_230
    andi R31, 127
    lpm RET_PTR_LO, Z+
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_231
LOAD_SRAM_GCPTR_230:
    ld RET_PTR_LO, Z+
DONE_LOAD_GCPTR_231:
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_232
    andi R31, 127
    lpm RET_PTR_HI, Z
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_233
LOAD_SRAM_GCPTR_232:
    ld RET_PTR_HI, Z
DONE_LOAD_GCPTR_233:
    pop R31
...
GET_CHAR_READTABLE_INDEX:
 ...
 ;;; this character's read-function resides.
    ...
    ldi R17, 9
    cp R16, R17
    brne SUCCESS_CONDITION_END_236
    ldi R17, 0
    rjmp IS_SYM_234
SUCCESS_CONDITION_END_236:
    ;; Test for carriage return
    ldi R17, 10
    cp R16, R17
    brne SUCCESS_CONDITION_END_237
    ldi R17, 1
    rjmp IS_SYM_234
SUCCESS_CONDITION_END_237:
    ;; Test for line feed
    ldi R17, 13
    cp R16, R17
    brne SUCCESS_CONDITION_END_238
    ldi R17, 1
    rjmp IS_SYM_234
SUCCESS_CONDITION_END_238:
...
ASM_PEEK_CHAR:
    ...
    tst RET_NONPTR_HI
    breq SUCCESS_CONDITION_END_239
    call ASM_UNPUT_CHAR
SUCCESS_CONDITION_END_239:
...
BEGIN_LOOP_240:
    cp R20, ZERO
    cpc R21, ZERO
    breq SUCCESS_CONDITION_END_242
    subi R20, 1
    ldi R25, 0
    sbc R21, R25
    ld R22, Y+
...
GC_ALLOC:
    ...
    cp R16, R18
    cpc R17, R19
    brlo SUCCESS_CONDITION_END_243
    jmp FATAL_ERROR
SUCCESS_CONDITION_END_243:
...
BEGIN_LOOP_244:
    cp R30, ZERO
    cpc R31, ZERO
    breq SUCCESS_CONDITION_END_246
    ;; Increment Z to skip the header byte
    adiw R31:R30, 1
    ;; Load the CAR of the list into r17:r16
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_247
    andi R31, 127
    lpm R16, Z+
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_248
LOAD_SRAM_GCPTR_247:
    ld R16, Z+
DONE_LOAD_GCPTR_248:
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_249
    andi R31, 127
    lpm R17, Z+
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_250
LOAD_SRAM_GCPTR_249:
    ld R17, Z+
DONE_LOAD_GCPTR_250:
    ...
    tst RET_NONPTR_LO
    breq SUCCESS_CONDITION_END_251
    jmp END_LOOP_245
SUCCESS_CONDITION_END_251:
...
DONE_LOAD_GCPTR_253:
    sbrs R31, 7
    rjmp LOAD_SRAM_GCPTR_254
    andi R31, 127
    lpm R17, Z
    ori R31, 128
    rjmp DONE_LOAD_GCPTR_255
LOAD_SRAM_GCPTR_254:
    ld R17, Z
DONE_LOAD_GCPTR_255:
    movw R31:R30, R17:R16
    jmp BEGIN_LOOP_244
SUCCESS_CONDITION_END_246:
END_LOOP_245:
